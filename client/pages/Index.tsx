...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Track scans, locations, and engagement metrics in real-time",
    },
    {
      icon: Shield,
  ...
  return (
    <Layout>
      <div className="space-y-16">
        ...
        <section className="text-center space-y-8 py-12">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Create, customize, and track QR codes with powerful analytics. The
              complete solution for modern businesses.
            </p>
          </div>
        ...
        {/* Stats */}
        <section className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-10 pb-10">
          {stats.map((stat, index) => (
            <Card
              key={index}
              className="text-center border-0 shadow-lg bg-white/50 dark:bg-card/50 backdrop-blur-sm"
            >
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to create, manage, and analyze QR codes at
              scale
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-0 shadow-lg bg-white/50 dark:bg-card/50 backdrop-blur-sm hover:shadow-xl transition-shadow"
              >
                <CardHeader>
